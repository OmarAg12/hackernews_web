...
LINEAR_SERVER_URL = 'https://linear-model-service-omarag12.cloud.okteto.net/v1/models/linear-model:predict'

RESNET_SERVER_URL = 'https://resnet-service-omarag12.cloud.okteto.net/v1/models/resnet:predict'
